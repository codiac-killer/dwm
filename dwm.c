...
#endif /* XINERAMA */
// #include <X11/extensions/shape.h>  // rounded corners
...
// static void drawroundedcorners(Client *c);  // rounded corners
...
manage(Window w, XWindowAttributes *wa)
{
	...
	// drawroundedcorners(c);  // rounded corners
...
setup(void)
{
	...
	netatom[NetSystemTrayOrientationHorz] = XInternAtom(dpy, "_NET_SYSTEM_TRAY_ORIENTATION_HORZ", False);	netatom[NetWMName] = XInternAtom(dpy, "_NET_WM_NAME", False);
...
// Change - Move clients without untiling --------------------------------------
